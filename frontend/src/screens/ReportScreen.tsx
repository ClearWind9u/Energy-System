...
export default function ReportScreen({ navigation, route }: any) {
  ...
  return (
    <View style={[styles.container, currentStyles.container]}>
      ...
      <TouchableOpacity
  style={[styles.chartButton, currentStyles.chartButton]}
  onPress={() => navigation.navigate("Chart", { selectedDate, userID })}
>
  <FontAwesome name="pie-chart" size={20} color={currentStyles.chartButton.color} />
  <Text style={[styles.chartButtonText, currentStyles.text]}>Xem biểu đồ theo năm</Text>
</TouchableOpacity>
...
const dayModeStyles = StyleSheet.create({
  ...
  chartButton: { backgroundColor: "#F5F9FF", color: "#4A90E2" },
...
const nightModeStyles = StyleSheet.create({
  ...
  chartButton: { backgroundColor: "#2A3447", color: "#6B9BF2" },
